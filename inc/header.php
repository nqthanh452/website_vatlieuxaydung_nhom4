...
<body>
	<div class="wrap">
		<div class="header_top">
			<div class="logo">
				<a href="index.php"><img src="images/Logonew.JPG" alt="" /></a>
			</div>
  			<div>
  				<a href="index.php"><img src="images/Banner.png" alt="" /></a>
			</div>
			  <div class="header_top_right">
			    <div class="search_box">
				    <form>
				    	<input type="text" value="Tìm kiếm..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Tìm kiếm...';}"><input type="submit" value="Tìm kiếm">
				    </form>
			    </div>
