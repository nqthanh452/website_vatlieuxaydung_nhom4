	...
	class brand
{
	...
	public function insert_brand($brandName){
		...
		public function update_brand($brandName,$id){
			...
			if(empty($brandName)){
				...
				if($result){
					...
					$alert= "<span class = 'error'>Update thương hiệu không thành công</span>";
					return $alert;
				}
			}
		...
		public function del_brand($id){
			$query = " DELETE tbl_brand WHERE brandId = '$id'";
				$result = $this->db->delete($query);
				if($result){
					$alert = "<span class = 'success'>Delete thương hiệu thành công</span>";
					return $alert;	
				}else{
					$alert= "<span class = 'error'>Delete thương hiệu không thành công</span>";
					return $alert;
				}
